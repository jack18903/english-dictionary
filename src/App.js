...
export const App = () => {
  ...
  const [voiceSelected, setVoiceSelected] = useState("Microsoft David - English (United States)")
  ...
  return (
    <div className="container">
      ...
      <form>
        <div className="row">
          <textarea spellcheck="false" cols="30" rows="4"
            placeholder='Enter text' value={text} onChange={e => setText(e.target.value)}/>
